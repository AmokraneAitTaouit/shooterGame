...
# definir une classe qui vas s'occuper des animations
class AnimateSprite(pygame.sprite.Sprite):
    ...
    def __init__(self, sprite_name, size=(200, 200)):
        ...
        self.current_image = 0  # commencer a l'image 0
...
def load_animation_images(sprite_name):
    # charger les 24 images de ce sprite daans le dossier correspondant
    image = []
    ...
    # recupere la liste d'image
    return image


# definir un dictionnaire qui va contenir les images charges de chaque sprite
animation = {
